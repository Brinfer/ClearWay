...
\begin{center}
    ...
    \captionof{figure}{Comparaison des bibliothèques ImageAI et OpenCV à 1 ips}
\end{center}
...
\begin{center}
    ...
    \end{tabular}
    \captionof{table}{Comparaison de l'efficacité des 2 programmes suivant leurs différents paramètres à 1 ips}
    \label{tab_1fps}
\end{center}
...
\begin{center}
    ...
    \captionof{figure}{Comparaison des bibliothèques ImageAI et OpenCV à 2 ips}
\end{center}
...
\begin{center}
    ...
    \end{tabular}
    \captionof{table}{Comparaison de l'efficacité des 2 programmes suivant leurs différents paramètres à 2 ips}
    \label{tab_2fps}
\end{center}
...
\begin{center}
    ...
    \captionof{figure}{Comparaison des bibliothèques ImageAI et OpenCV à 3 ips}
\end{center}
...
\begin{center}
    ...
    \end{tabular}
    \captionof{table}{Comparaison de l'efficacité des 2 programmes suivant leurs différents paramètres à 3 ips}
    \label{tab_3fps}
\end{center}
