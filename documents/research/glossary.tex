...
\newglossaryentry{CNIL}{
    ...
    description={(CNIL) Autorité administrative indépendante chargé du respect de la privée en France. 
...
\newglossaryentry{CSI}{
    ...
    description={(CSI) Code juridique créé en 2012 pour regrouper l'ensemble des dispositions législatives et réglementaires ayant trait à la sécurité intérieure.},
    plural={CSI},
    text={CSI},
...
\newglossaryentry{FPGA}{
    name={FPGA},
    description={(FPGA) Field Programmable Gate Array (Réseau de portes programmables), sont des puces électroniques},
    plural={FPGA},
    text={FPGA},
...
\newglossaryentry{VPU}{
    name={VPU},
    description={(VPU) Cette technologie récente sont des systèmes sur puce pour l'acquisition et l'interprétation visuelle.},
    plural={VPUs},
    text={VPU},
...
\newglossaryentry{IA}{
    ...
    description={(IA) Consiste à mettre en œuvre un certain nombre de techniques visant à permettre aux machines d'imiter une forme d'intelligence réelle.},
    plural={IA},
    text={IA},
