...
En étudiant les manuels d'installation des fabricants de caméras, nous obtenons les paramètres suivants :
\begin{itemize}
...
car soit le champ de vison est trop large soit trop étroit. Ainsi elles ne seront pas prises en compte dans le paragraphe suivant.
...
En éliminant les trois cas précédents, ils nous restent uniquement le cas 2, qui correspond aux exigences spécifiées dans le paragraphe \ref{sec:camera_cycliste}.
